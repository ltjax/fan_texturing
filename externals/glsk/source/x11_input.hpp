...
**		version-info:   $Id: x11_input.hpp 101 2009-01-26 02:21:58Z ltjax $
**
*/

#ifndef _glsk_x11_input_h_
#define _glsk_x11_input_h_
...
namespace glsk { namespace detail {
	...
	void input_init_keytable();

	unsigned int input_translate_key( KeySym symbol );
	void input_update_pointer_move( int x, int y, glsk::window* window );
	void input_update_pointer_button( int x, int y, int index, bool down, glsk::window* window );
	void input_update_pointer_owner();

	class keycode_hash;


#ifndef _glsk_no_keycodes_h_
...
#define KEY_ALT_GR          0xB8    // right Alt
